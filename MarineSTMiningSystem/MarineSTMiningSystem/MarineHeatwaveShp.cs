...
{
    internal class MarineHeatwaveShp:Shp
    {
        public List<MarineHeatwavePolygon> stormPolyList = new List<MarineHeatwavePolygon>();//暴雨多边形链表
        public List<int> stormIdList = new List<int>();//包含的暴雨事件id
        private string spaRefWkt = string.Empty;//坐标参考

        public MarineHeatwaveShp()
        {

        }

        public MarineHeatwaveShp(string path)
        {
            url = path;
