...
namespace MarineSTMiningSystem
{
    class MarineHeatwave
    {
        ...
        public double IMean;//平均降雨量
        public double volume;//累计降雨量
        public double IMax = double.MinValue;//最大降雨量
        public double IMin = double.MaxValue;//最小降雨量
        public double maxIMean = double.MinValue;//最大平均降雨量，一个时刻的
        public double minIMean = double.MaxValue;//最小平均降雨量，一个时刻的
        ...
        public MarineHeatwavePolygon headPoly = new MarineHeatwavePolygon();//头多边形
        public List<Feature> featureList = new List<Feature>();//要素列表
        public List<MarineHeatwavePolygon> polygonList = new List<MarineHeatwavePolygon>();//暴雨多边形列表
        ...
        public double NodeMaxArea = 0;//事件包含节点的最大面积
        public MarineHeatwave()
        {//构造函数
